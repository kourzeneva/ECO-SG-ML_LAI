...
!          FMI, 07.2025
 ...
 INTEGER, PARAMETER, DIMENSION(2) :: NlonB_all = (/ 129600, 137600 /) , & ! Number of longitude pixels of the LAI and ML bitmaps
                                     NlatB_all = (/ 50400,  96600 /)      ! Number of latitude pixels of the LAI and ML bitmaps
 REAL(8), PARAMETER, DIMENSION(2) :: PixSize_all = (/ 10.0_8, 1.94036112_8 /)      ! Pixel size of the LAI and ML bitmaps in seconds of arc(s)

 CHARACTER(10), PARAMETER, DIMENSION(2) :: BitmapFile_all = (/'bitmap_LAI','bitmap_ML '/) ! The LAI and ML bitmap file names
 ...
 REAL(KIND=8), DIMENSION(2), PARAMETER :: WestLim_all = (/ -180.0_8, -31.9997305054148_8 /), & ! Western boundaries of the LAI and ML bitmaps
                                          NorthLim_all = (/ 80.0_8, 72.0660843734148_8 /)      ! Northern boundaries of the LAI and ML bitmaps
      
 REAL(KIND=8), DIMENSION(2) :: EastLim_all, & ! Eastern boundaries of the LAI and ML bitmaps
